                        ...
                        <div class="bill-to">
                            ...
                            <div class="form-one">
                                <form method="POST">
                                    ...
                                    <textarea name="shipping_note" class="shipping_note" placeholder="Ghi chú đơn hàng " rows="16"></textarea>
                                        ...
                                        <table class="table table-condensed">
                                            ...
                                            <tbody>
                                                @if (Session::get('cart') == true)
                                                    ...
                                                    @endforeach
                                                    <tr>
                                                        <td><input type="submit" value="Cập nhật giỏ hàng"
                                                                name="update_qty"
                                                                class="check_out btn btn-default btn-sm">
                                                        </td>
                                                        <td><a class="btn btn-default check_out"
                                                                href="{{ url('/del-all-product') }}">Xóa tất
                                                                cả</a></td>
                                                        <td>
                                                            @if (Session::get('coupon'))
                                                                <a class="btn btn-default check_out"
                                                                    href="{{ url('/unset-coupon') }}">Xóa
                                                                    mã khuyến mãi</a>
                                                            @endif
                                                        </td>
                                                        <td colspan="2">
                                                            ...
                                                            @if (Session::get('fee') > 0)
                                                                <li> <a
                                                                        class="cart_quantity_delete"href="{{ url('/del-fee/') }}"><i
                                                                            class="fa fa-times"></i></a>
                                                                    Phí vận chuyển :
